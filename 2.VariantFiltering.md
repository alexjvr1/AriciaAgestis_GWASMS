...
After filtering, kept 251 out of 251 Individuals
Outputting VCF file...
After filtering, kept 79420 out of a possible 128876 Sites
...
These stats are based on the dataset after filtering for MAF 1% (79420 loci)
...
Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  7.908 127.191 168.126 184.139 207.423 627.774 
```
...
```
vcftools --vcf AAgestis.261_FINAL.newnames.vcf --maf 0.01 --recode --recode-INFO-all --out AAgestis.251_FINAL.minMAF0.01.recode.vcf
...
After filtering, kept 251 out of 251 Individuals
After filtering, kept 9474 out of a possible 79420 Sites
```
...
After filtering, kept 251 out of 251 Individuals
After filtering, kept 57689 out of a possible 57689 Sites
Run Time = 1.00 seconds
```

This leaves 57k loci (up from ~31k in the Pop Gen paper)
...
mv 1a_Aricia_agestis_GWASdata/04_Outlier/VCF_perpop/test/AA251.merge0.5missing.vcf AA251.FINAL.MAF0.01.missing0.5perpop.vcf
...
```
vcftools --vcf AAgestis.251_FINAL.minMAF0.01.recode.vcf --maf 0.05 --recode --recode-INFO-all --out AAgestis.251.MAF0.05.FINAL
...
Parameters as interpreted:
	--vcf AAgestis.251_FINAL.minMAF0.01.recode.vcf
	--recode-INFO-all
	--maf 0.05
...
After filtering, kept 251 out of 251 Individuals
Outputting VCF file...
After filtering, kept 45693 out of a possible 79420 Sites
...
After filtering, kept 251 out of 251 Individuals
After filtering, kept 8660 out of a possible 45693 Sites
```
