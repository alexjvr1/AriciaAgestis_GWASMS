...
vcftools --bcf Aagestis.raw.bcf --minQ 100 --min-meanDP 10 --max-meanDP 255 --max-alleles 2 --max-missing 0.3 --recode --recode-INFO-all --out AAgestis_FINAL

VCFtools - v0.1.12b
(C) Adam Auton and Anthony Marcketta 2009

Parameters as interpreted:
	--vcf Aagestis.raw.bcf
	--recode-INFO-all
	--max-alleles 2
	--max-meanDP 255
	--min-meanDP 10
...
After filtering, kept 89704 out of a possible 558840 Sites
